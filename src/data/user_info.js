const info = {
    ...
    skills: {
        languages: {
            description: "I possess proficient expertise in a diverse range of programming languages, including C, C++, C#, Python and Java.",
            image: "https://skillicons.dev/icons?i=c,cpp,cs,py,java&perline=6&theme="
        },
        frameworks: {
            description: "Experienced in a versatile tech stack, including React, Express.js, Node.js, PostgreSQL, Tailwind CSS, and PyTorch.",
