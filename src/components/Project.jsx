...
function Project({ theme, title, description, technologies, link, github }) {
  return (
    <div className="hover:bg-gray-50 hover:dark:bg-[#101e38] transition-all duration-300 p-6 md:rounded-xl border dark:border-gray-500 p-8 rounded-xl">
        <img className="" src={technologies + theme} />
